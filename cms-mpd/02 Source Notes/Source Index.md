...
Use this note as the reviewed-source landing page for the current Medicare plan study set.

## Current Source Syntheses
...
- Reform and benefit design
- Subsidies and eligibility operations
- Insulin affordability and drug-specific policy
- Counseling and plan navigation
- Beneficiary communication and readability
- Pricing, formulary, and data infrastructure
- Operations, enrollment, bidding, and sponsor guidance
- Market structure, enrollment, and premium trends
- Oversight and affordability monitoring
- MedPAC annual status reports and market oversight
- Economics of market design and insurer incentives
...
- What is the source trying to explain, regulate, or measure?
- Which topic notes should this source feed?
- Is the source historical, current, or mixed across multiple policy years?
- Does the source support beneficiary counseling, data analysis, or both?

## Next Step

Use [[Article Note Template]] or [[Reference Note Template]] when you add the next reviewed note from the inbox or the pending PDF set.
