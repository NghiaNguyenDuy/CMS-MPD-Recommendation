...
16. [README](../../../README.md)
17. [architecture-lineage.md](../../../docs/architecture-lineage.md)
18. [technical-data-flow-modeling.md](../../../docs/technical-data-flow-modeling.md)
19. [study-research-flow-data-logic-algorithm.md](../../../docs/study-research-flow-data-logic-algorithm.md)
20. [hybrid_reranker_dataset.metadata.json](../../../data/training/2025-Q3/full/hybrid_reranker_dataset.metadata.json)
21. [hybrid_reranker_evaluation_tree.json](../../../data/training/2025-Q3/full/hybrid_reranker_evaluation_tree.json)
22. Cai Y, Yu F, Kumar M, Gladney R, Mostafa J. Health recommender systems development, usage, and evaluation from 2010 to 2022: a scoping review. *International Journal of Environmental Research and Public Health*. 2022;19(22):15115.
23. Ananthakrishnan A, Milne-Ives M, Cong C, Meinert E. The evaluation of health recommender systems: a scoping review. *International Journal of Medical Informatics*. 2025;195:105697.
